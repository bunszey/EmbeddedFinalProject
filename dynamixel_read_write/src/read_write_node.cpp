...
//#define ADDR_OPERATING_MODE 11 not applicable, operation mode is defined by restriction of clockwise and counter-clockwise angle limits
...
{
  // Set angle limits, so that the motor is in position control mode
